  ...
  return (
    <div className="max-w-[1200px] mx-auto mb-32">
      <div className="flex flex-col px-5">
        <Title title="Verify your Products" className="mt-5" />
        <div className="grid grid-cols-1 md:grid-cols-2">
          {/* Carrito */}
          <div>
            <div className="flex flex-col my-5">
              <span className="text-md font-medium">Edit items</span>
              <div>
                <Link
                  href="/"
            ...
            <div className="bg-white rounded-xl shahow p-7 md:ml-32 h-auto gap-4 flex flex-col">
              ...
              <div className="mb-2">
                <p className="text-sm">
                  ...
                  <a href="#" className="shadow-link hover:shadow-link-hover transition-all">
                    privacy notice
                  </a>{' '}
                  and{' '}
                  <a href="#" className="shadow-link hover:shadow-link-hover transition-all">
              ...
              <Link href="/orders/123" className="text-center btn-primary mb-3">
                Place Order
              </Link>
            </div>
          </div>
